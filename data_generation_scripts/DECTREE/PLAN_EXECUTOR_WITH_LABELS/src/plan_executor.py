...
class Executor:
    ...
    def __init__(self, robot_domain_model, robot_problem, plan_file, spl_features, feat_x, feat_y):
    ...
    def execute_plan(self):
        ...
        for act in self.plan:
            ...
            if act.split('_')[0] == "move" or "fetch" in act:
                ...
                beh_trace.append(" ".join([str(i) for i in full_feats])+" "+ "_".join(act.split('_')[:1]))
...
#    label = sys.argv[4]
    ...
    exc = Executor(dom, prob, plan, spl_features, feat_x, feat_y)
