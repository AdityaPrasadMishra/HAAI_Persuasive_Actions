...
class PuddleMDP(GridWorldMDP):
    ...
    def __init__(self, gamma=0.99, slip_prob=0.00, name="puddle", puddle_rects=[(0.4, 0.6, 0.9, 0.4), (0.0, 0.6, 0.4, 0.4)], goal_locs=[[1.0, 1.0]], is_goal_terminal=True, rand_init=False, step_cost=0.0):
        '''
        Args:
            gamma (float)
            slip_prob (float)
